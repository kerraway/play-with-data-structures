...
/**
 * V5 implement, based on v4 implement, uses path compression to reduce ranks.
 *
 * @author kerraway
 * @date 2019/04/16
 */
public class UnionFindImplV5 implements UnionFind {
  ...
  public UnionFindImplV5(int size) {
